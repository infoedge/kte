...
<div class="videolist-form">
    ...
    <div class="row">
        <div class="col-sm-2">
            <?= $form->field($model, 'vTopic')->dropDownList(ArrayHelper::map(Videotopics::find()->all(),'id','topicName'),['prompt'=>'-Select Video Topic-']) ?>
        </div>
        <div class="col-sm-3">
    ...
    <?= $form->field($model, 'vid')->textInput(['maxlength' => true]) ?>
        ...
        <div class="col-sm-5">
            <?= $form->field($model, 'vDesc')->textarea(['maxlength' => true]) ?>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <?= $form->field($model, 'videoType')->dropDownList(ArrayHelper::map(Videotypes::find()->all(),'id','typeName')) ?>
        </div>
        <div class="col-sm-2">
