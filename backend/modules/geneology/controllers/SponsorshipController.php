...
namespace backend\modules\genealogy\controllers;

use Yii;
use backend\modules\genealogy\models\Sponsorship;
use backend\modules\genealogy\models\SponsorshipSearch;
...
class SponsorshipController extends Controller
{
    ...
    public function actionAddPerson(){
        //if(Yii::$app->request->post('Btn')==1 ){
                Yii::$app->session['backlink']='/genealogy/sponsorship/create';
