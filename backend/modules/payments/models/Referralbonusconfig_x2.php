...
class Referralbonusconfig extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sPackage', 'sRank', 'mPackage', 'trxType', 'level', 'amount', 'recordBy', 'recordDate', 'configCntrl'], 'required'],
            [['sPackage', 'sRank', 'mPackage', 'trxType', 'level', 'recordBy', 'changedBy', 'changedDate'], 'integer'],
            [['amount'], 'number'],
            [['recordDate'], 'safe'],
