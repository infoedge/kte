...
use backend\modules\reports\models\Membershiphistory;

/**
 * MembershiphistorySearch represents the model behind the search form of `backend\modules\reports\models\Membershiphistory`.
 */
