...
use backend\modules\reports\models\SponsorshipSearch;
...
class SponsorshipController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'only' => ['index','view','create','delete','update','showStats'],
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['errorpage'],
                    ...
                    [
                        'allow' => true,
                        'actions' => ['index','view','create','delete','update','showStats'],
                        'roles' => ['admin'],
                    ],
    ...
    public function actionShowStats()
    {
        $model = new SponsorshipSearch();
        $dataProvider = $model->getStatsDataProvider();
        return $this->render('showstats', [
            'dataProvider' => $dataProvider,
