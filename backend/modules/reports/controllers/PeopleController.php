...
use backend\modules\reports\models\PeopleSearch;
...
class PeopleController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'only' => ['index','view','create','delete','update','prospects'],
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['errorpage'],
                    ...
                    [
                        'allow' => true,
                        'actions' => ['index','view','create','delete','update','prospects'],
                        'roles' => ['admin'],
                    ],
    ...
    {
        $searchModel = new PeopleSearch();
        $dataProvider = $searchModel->searchProspects(Yii::$app->request->queryParams);

        return $this->render('prospects', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
