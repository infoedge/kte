...
/**
 * CFlagsSearch represents the model behind the search form of `backend\modules\basic\models\CFlags`.
 */
class CFlagsSearch extends CFlags
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'c_id'], 'integer'],
            [['country', 'countryFlag','c.Name'], 'safe'],
        ];
    }
