...
<div class="people-form">
    ...
    <!--<?= $form->field($model, 'dob')->textInput() ?>-->
        ...
        <div class="col-sm-3">
    <?= $form->field($model, 'nationality')->dropdownList(ArrayHelper::map(Countries::find()->all(),'id','Name')
            ,[
                'prompt'=>'Enter National Of',
                
                ]) ?>
        </div>
        <div class="col-sm-3">
    <?= $form->field($model, 'city')->dropdownList(ArrayHelper::map(Cities::find()->all(),'id','city'),['prompt'=>'--City/Town--']) ?>
        </div>
    </div>
    <div class="row">
