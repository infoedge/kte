...
<div class="basic-default-index">
    ...
    <div class="col-sm-4">
        <h2>General</h2>
        <?= Html::a(Yii::t('app','Countries'),['countries/create'],['class'=>'btn btn-primary btn-block']) ?></br>
        <?= Html::a(Yii::t('app','Cities'),['cities/create'],['class'=>'btn btn-primary btn-block']) ?></br>
        <?= Html::a(Yii::t('app','Country Dial codes'),['dialcodes/create'],['class'=>'btn btn-primary btn-block']) ?></br>
        <?= Html::a(Yii::t('app','Country Flags'),['c-flags/create'],['class'=>'btn btn-primary btn-block']) ?></br>
    </div>
    <div class="col-sm-4">
        <h2>Settings</h2>
