...
use backend\modules\dashboard\models\Tblrankearnings;

/**
 * TblrankearningsSearch represents the model behind the search form of `backend\modules\dashboard\models\Tblrankearnings`.
 */
