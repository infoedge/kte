...
class People extends \yii\db\ActiveRecord
{
    ...
    public function getFullName(){
        return $this->title->title.' ' .$this->firstName.( is_Null($this->otherNames)? ' ': ' '.$this->otherNames).' '.$this->surname. '; Membership #: '.$this->sponsorship->membershipNo. ' Member Id: '.$this->sponsorship->member;
    }
}
