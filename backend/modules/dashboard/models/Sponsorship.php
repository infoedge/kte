...
class Sponsorship extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'Rank' => Yii::t('app', 'Rank'),
            'prefPosition' => Yii::t('app', 'Pref Position'),
    ...
    public function getCurrentMemberHistory()
    {
        return $this->getMembershiphistories()->andWhere(['dateEnd'=>null])->one();
    }
    public function getFullName()
    {
        return $this->member0->fullName;
    }
}
