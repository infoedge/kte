...
use backend\modules\dashboard\models\Tblpoints;

/**
 * TblpointsSearch represents the model behind the search form of `backend\modules\dashboard\models\Tblpoints`.
 */
