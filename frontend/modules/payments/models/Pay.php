...
class Pay extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['memberId', 'trxId', 'packId', 'confirms_needed','channel', 'payMethod'], 'integer'],
            [['dateStart', 'statusDate'], 'safe'],
            [['amount'], 'number'],
            [['e_mail'],'email'],
            [['mobileNo'],'string'],
            [['mobileNo'],'required','when'=>function($model){
              return  ($model->channel==1||$model->channel==3);}
            ],
            ['channel','required','when'=>function($model){return $model->payMethod ==11;}],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'mobileNo'=> Yii::t('app', 'Paying Mobile #'),
            'trxId' => Yii::t('app', 'Transaction Type'),
            'packId' => Yii::t('app', 'Package'),
            'payMethod' => Yii::t('app', 'Pay Method'),
