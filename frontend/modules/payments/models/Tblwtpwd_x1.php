...
class Tblwtpwd extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            //[['id', 'auth_key', 'password_hash', 'verification_token', 'peopleId', 'created_at', 'updated_at'], 'required'],
            [['pwd'],'required'],
            ['pwd_repeat', 'compare', 'compareAttribute' => 'pwd'],
            [['id', 'peopleId', 'status', 'created_at', 'updated_at'], 'integer'],
            [['userid', 'password_hash', 'password_reset_token', 'verification_token'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'pwd'=> Yii::t('app', 'Wallet Password'),
            'pwd_repeat'=> Yii::t('app', 'Confirm Wallet Password'),
