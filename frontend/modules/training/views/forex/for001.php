...
$this->title = "Forex Trading Knowledge";
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Training'), 'url' => ['/dashboard/membership/training']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Forex Trading'), 'url' => ['/training/forex/index']];
...
<div class="training-default-index">
    ...
    <?= \yii2assets\pdfjs\PdfJs::widget([
        'url'=> Url::base().'/../modules/training/files/forex/for001_forex_trading_knowledge.pdf',
        'buttons'=>[
