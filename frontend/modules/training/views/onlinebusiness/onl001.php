...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Online Business Opportunities'), 'url' => ['/training/onlinebusiness/index']];
...
<div class="training-default-index">
    ...
    <?= \yii2assets\pdfjs\PdfJs::widget([
        'url'=> Url::base().'/../modules/training/files/onlinebusiness/onl001_online_business_opportunities.pdf',
        'buttons'=>[
