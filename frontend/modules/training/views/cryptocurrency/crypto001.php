...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Cryptocurrency'), 'url' => ['/training/cryptocurrency/index']];
...
<div class="training-default-index">
    ...
    <?= \yii2assets\pdfjs\PdfJs::widget([
        'url'=> Url::base().'/../modules/training/files/cryptocurrency/Crypto001_Cryptocurrency_Knowledge.pdf',
        'buttons'=>[
