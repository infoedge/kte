...
<ol>
 ...
 <?php $form = ActiveForm::begin(); ?>
    ...
    <div class="forex-video">
        <div class="row">
            <div class="col-sm-8">
                <?= $form->field($model, 'vid')->dropdownList(ArrayHelper::map(Videolist::find()->where(['vTopic' => 3])->all(), 'vid', 'vName'), ['prompt' => '-Select Video-'])->label('Video Name') ?>
            </div>
            <div class="col-sm-2">
...
$(function (){
    ...
    $('#videolist-vid').change( function(){
        ...
        //alert("video: " + id) ;
        $.get("index.php?r=training/teambuilding/build-link",
             { id : id  },
             function(data){
