...
class OnlinebusinessController extends \yii\web\Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'allow' => true,
                        'actions' => ['index','onl001','build-link'],
                        'roles' => ['Diamond'],
                    ],
    ...
    public function actionIndex()
    {
        ...
        $video= Videolist::find()->with('videoType0')->where(['vTopic'=>11])->one();
        ...
        $videoCount = Videolist::find()->where(['vTopic' => 11])->count();
    ...
    public function actionOnl001()
    {
        return $this->render('onl001');
    }
