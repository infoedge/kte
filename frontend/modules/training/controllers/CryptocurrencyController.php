...
class CryptocurrencyController extends \yii\web\Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'only' => ['index','crypto001','build-link'],
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['errorpage'],
                    ...
                    [
                        'allow' => true,
                        'actions' => ['index','crypto001','build-link'],
                        'roles' => ['Diamond'],
                    ],
    ...
    public function actionCrypto001()
    {
        return $this->render('crypto001');
    }
    ...
    public function actionIndex()
    {
        ...
        $video= Videolist::find()->with('videoType0')->where(['vTopic'=>9])->one();
        $videoCount = Videolist::find()->where(['vTopic' => 9])->count();
