...
<table  class="table table-hover table-striped w-auto">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row"><a href="<?= Url::to(['/training/onlinebusiness/index']) ?>">10. Online Business Opportunities.</a></th>
            <td class="text-center">NO</td>
            <td class="text-center">YES</td> 
        </tr>
        <tr>
            <th scope="row"><a href="<?= Url::to(['/training/teambuilding/index']) ?>">11. Team Building.</a></th>
            <td class="text-center">NO</td>
            <td class="text-center">YES</td> 
        </tr>
        <tr>
