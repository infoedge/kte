    ...
    <body>
        ...
        <span class="thelogo img-responsive"><img src="images/knowledge_to_earn_Logo1.jpg"   height="100px"/></span>
            ...
            $menuItems = [
                ...
                ['label' => 'Genealogy', 'url' => ['/dashboard/membership/genealogy','memberId'=>Yii::$app->userdetails->getPersonId(Yii::$app->user->id)]],
                ['label' => 'Membership', 'url' => ['/dashboard/default/membership'], 'items' => [
                        ['label' => 'Profile', 'url' => ['/dashboard/profile/update','id'=> Yii::$app->userdetails->getPersonId(Yii::$app->user->id)]],
