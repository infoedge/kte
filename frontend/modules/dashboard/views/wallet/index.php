...
<div class="wallet-index">
    ...
    <div class="row">
        ...
        <?php $form = ActiveForm::begin(); ?>   
            ...
            <h3>Gift Codes</h3>
            <?= Html::a(Yii::t('app', 'Generate Gift Code'), ['/payments/gcodes/create'], ['class' => 'btn btn-success btn-block','disabled'=>($membership->walletBal) < 25?'disabled':null ]) ?>.
            ...
            <h3>Withdraw </h3>
            <?= Html::submitButton(Yii::t('app', 'Withdraw Funds'),  ['class' => 'btn btn-success btn-block', 'id'=>'rcvFunds','name'=>'btn','value'=>2,'disabled'=>$membership->walletBal < $minWalletWithdrawal?'disabled':null, 'title'=>$membership->walletBal < $minWalletWithdrawal?'Only active when Wallet Balance is >= $25.0':'']) ?>
            <?= Html::submitButton(Yii::t('app', 'View Withdraw Details'),  ['class' => 'btn btn-primary btn-block', 'id'=>'rcvFunds','name'=>'btn','value'=>3, 'title'=>'List Withdrawals']) ?><br>.
        <?php ActiveForm::end(); ?>
            </div>
    </div>
</div>
