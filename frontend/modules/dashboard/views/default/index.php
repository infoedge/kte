    ...
    <div class="row">
        ...
        <div class="col-md-3 centerpiece " >
            ...
            <h3>Sponsorship Bonus</h3><table class="table table-responsive table-striped" border="0" width="0">
                ...
                <tbody>
                    <tr>
                        <td>Pending to wallet:</td>
                        <td style="text-align:  center"><?= $membership->pointsPending; ?></td>
                    </tr>
                    <tr>
                        <td>Sent to wallet:</td>
                        <td style="text-align:  center"><?= $membership->pointsPaid; ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;Left</td>
                        <td style="text-align:  center"><?= $membership->noSponsoredLft ?></td>
                        
                    </tr>
                    <tr>
                        
                        <td>&nbsp;Right</td>
                        <td style="text-align:  center"><?= $membership->noSponsoredRgt ?></td>
            ...
            <table class ="table table-responsive table-striped" border="0" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align:  center"><?= $membership->cyclesPaid; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Pending Cycles:</strong></td>
                        <td style="text-align:  center"><?= $membership->cyclesPending; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Pending Left:</strong></td>
                        <td style="text-align:  center"><?= $membership->binaryLftPending; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Pending Right:</strong></td>
                        <td style="text-align:  center"><?= $membership->binaryRgtPending; ?></td>
                    </tr>
                </tbody>
            </table>
            <hr>
        ...
        <div class="col-md-3 centerpiece2">
            ...
            <table class="table table-responsive table-striped" border="0">
                ...
                <tbody>
                    <tr>
                        <td>Total Earned</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingAll,2) ?></td>
                    </tr>
                    <tr>
                        <td>Today</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingToday,2) ?></td>
                    </tr>
                    <tr>
                        <td>Yesterday</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingYesterday,2) ?></td>
                    </tr>
                    <tr>
                        <td>This Week</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingThisWeek,2) ?></td>
                    </tr>
                     <tr>
                        <td>Last Week</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingLastWeek,2) ?></td>
                     </tr>
                     <tr>
                        <td>This Month</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingThisMonth,2) ?></td>
                     </tr>
                    <tr>
                        <td>Last Month</td>
                        <td style="text-align:  center"><?= $fmt->asDecimal($membership->matchingLastMonth,2) ?></td>
                    </tr>
                </tbody>
            </table>
            <hr>
