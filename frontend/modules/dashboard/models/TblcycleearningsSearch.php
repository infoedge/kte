...
use frontend\modules\dashboard\models\Tblcycleearnings;

/**
 * TblcycleearningsSearch represents the model behind the search form of `frontend\modules\dashboard\models\Tblcycleearnings`.
 */
