...
use frontend\modules\dashboard\models\Tblpoints;

/**
 * TblpointsSearch represents the model behind the search form of `frontend\modules\dashboard\models\Tblpoints`.
 */
class TblpointsSearch extends Tblpoints
{
    ...
    {
        $query = Tblpoints::find()->where(['sponsor'=>$memberId])->orderBy('recordDate DESC');
