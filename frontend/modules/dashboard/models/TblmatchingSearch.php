...
use frontend\modules\dashboard\models\Tblmatching;

/**
 * TblmatchingSearch represents the model behind the search form of `frontend\modules\dashboard\models\Tblmatching`.
 */
